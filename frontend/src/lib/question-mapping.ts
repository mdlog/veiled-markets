 ...
 * 
 * NOTE: veiled_markets_v2.aleo is a NEW deployment
 * All old markets from veiled_markets.aleo (v1) are NOT accessible
 */
export function initializeQuestionMappings(): void {
    const mappings: Record<string, string> = {
        // Market 1 - Crypto (Ethereum $10k) - First market on veiled_markets_v2.aleo
